...
/**
 * Curated fallback data so the product always works — even with no API
 * keys and even if Overpass/Nominatim are slow or rate-limited. Covers the
 * headline destinations from the product brief.
 */
